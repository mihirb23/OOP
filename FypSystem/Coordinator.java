...
public class Coordinator extends Faculty{
    ...
    public Coordinator(String userId, String name, String password) {
    ...
    public void prompt() {
        ...
        do {
            System.out.println("=================================================");
            System.out.print( "FACULTY (COORDINATOR) INTERFACE\n");
            System.out.println("=================================================");
            ...
            System.out.println("5: View supervising projects");
            ...
            switch (choice) {
                ...
                break;
                case 9: 
                    currentAction = new CoordinatorViewAllProject(this);
                break;
                case -1:
